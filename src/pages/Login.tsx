    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F1F5F9] font-sans">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl flex flex-col items-center">
        ...
        <p className="text-slate-500 mb-8 text-center text-sm">
          Sign in to create, manage, and publish your professional portfolio seamlessly.
        </p>

        <button
          onClick={handleLogin}
          className="w-full bg-white border border-slate-200 text-slate-700 font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-3 hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm"
        >
